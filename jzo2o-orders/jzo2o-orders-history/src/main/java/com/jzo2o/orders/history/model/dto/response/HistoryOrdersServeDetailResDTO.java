...
@Data
@ApiModel("服务单详情明细")
public class HistoryOrdersServeDetailResDTO {
     ...
     * @return
     */
    public static HistoryOrdersServeDetailResDTO empty() {
        HistoryOrdersServeDetailResDTO historyOrdersServeDetailResDTO = new HistoryOrdersServeDetailResDTO();
        historyOrdersServeDetailResDTO.setServeInfo(new ServeInfo());
        historyOrdersServeDetailResDTO.setCustomerInfo(new CustomerInfo());
        historyOrdersServeDetailResDTO.setOrdersInfo(new OrdersInfo());
        historyOrdersServeDetailResDTO.setRefundInfo(new RefundInfo());
        historyOrdersServeDetailResDTO.setCancelInfo(new CancelInfo());
